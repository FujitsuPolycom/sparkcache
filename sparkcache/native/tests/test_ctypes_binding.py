...
import pytest
import sparkcache.native.python as package_native
import sparkcache.spark_cache_native as native


def test_native_python_package_reexports_the_canonical_binding() -> None:
    assert package_native.PlacementConfig is native.PlacementConfig
    assert package_native.NativePlacementError is native.NativePlacementError
