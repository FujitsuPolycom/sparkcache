...
This is not a CUDA correctness claim. It gives
`native/app/spark_cache_snapshot_matrix_probe.cu` an exact fixture and
comparison oracle without importing torch, vLLM, or CUDA.
"""
...
def gather_reference_records(
    ...
    """Gather through the canonical Python record packer."""
...
def compare_ready_view(
    ...
    """Compare candidate record slices against the canonical snapshot codec."""
