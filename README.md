...
The qualified experimental community derivative is
...
| GLM-5.3 Flash hybrid pages with BF16 DFlash2 using seven draft tokens at TP4/DCP1 | **qualified** | Immutable OCI image `cd4045...`; `GLM53_FLASH_DFLASH7_LIVE_VALIDATION.md`; 8,192 restored tokens in 156.8–171.8 ms per rank; restored request 1.902 s |
